...
{
    public class onyxGun : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            else
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, bulletVelocity, ProjectileID.BlackBolt, Projectile.damage, Projectile.knockBack, Projectile.owner);
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (closestNPC == null)
                {
                    launchVelocity = -Projectile.velocity.RotatedByRandom(MathHelper.ToRadians(-15f + 10f * i));
                ...
                {
                    Vector2 bulletVelocity = (closestNPC.Center - Projectile.Center).SafeNormalize(Vector2.Zero) * projSpeed;
                    launchVelocity = bulletVelocity.RotatedByRandom(MathHelper.ToRadians(-15f + 10f * i));
