...
{
    public class Unknown2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 10 == 0 && Projectile.timeLeft != 0)
            {
                ...
                //add dusts
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center - bulletVelocity * 30, bulletVelocity, ModContent.ProjectileType<fakeRock>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
