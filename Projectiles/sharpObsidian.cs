...
{
    public class sharpObsidian : ModProjectile
    {
        public override void SetDefaults()
        {
            Projectile.Name = "sharpObsidian"; //Name of the projectile, only shows this if you get killed by it
        ...
        public override void Kill(int timeleft)
        {
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                Main.rand.NextBool(4)
                    ? Item.NewItem(Item.GetSource_NaturalSpawn(), Projectile.position, ModContent.ItemType<ObsidianShard>())
                    : 0;
            }
        }
    }
